...
def main():
    ...
    np.savez_compressed(out_mon_path, dir_seq=dir_seq_mon, labels=labels_mon)
    
    # Free memory
    del mon_data, m_data, m_labels, dir_seq_mon, labels_mon
    ...
    np.savez_compressed(out_unmon_path, dir_seq=dir_seq_unmon, labels=labels_unmon)
